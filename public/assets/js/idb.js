...
// this function will be execcuted if we attempt to submit a new pizza and there's no internet connection
// aka when the submission function .fetch() executes the .catch()
...
function uploadPizza() {
    ...
    // getAll() method is asynchronous so you need to attach an event handler in order to retrieve the data
